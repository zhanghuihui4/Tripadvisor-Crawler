...
class WebCrawler:
    def __init__(self,city_url,hotel_info_output_path,review_output_path):
    ...
    def get_hotel_detailed_info(self):
        ...
        hotel_url_df.to_csv(self.hotel_info_output_path, index=False)
        return hotel_url_df
...
def main():
    ...
    tripadvisor_crawler = WebCrawler(city_url,hotel_info_output_path,review_output_path)
